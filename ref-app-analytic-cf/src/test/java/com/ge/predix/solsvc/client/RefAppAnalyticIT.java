...
public class RefAppAnalyticIT
{
    ...
    @Autowired 
    private TimeseriesWSConfig timeseriesWSConfig;
    ...
    private List<Header> generateHeadersForTimeseries(){
    	 List<Header> headers = this.restClient.getSecureTokenForClientId();
    	 this.restClient.addZoneToHeaders(headers, this.timeseriesWSConfig.getZoneId());
    ...
    public void testRefAssetAnalytic()
    {
        ...
        createMetrics(generateHeadersForTimeseries());
        ...
        List<Model> models = this.modelFactory.getModels("/asset/compressor-2015.tag-extensions.crank-frame-discharge-pressure", "Asset", headers);
        ...
        CloseableHttpResponse httpResponse = this.restClient.post(this.refappAnalyticEndpoint,
                analyticRequest, headers, this.restConfig.getDefaultConnectionTimeout(), this.restConfig.getDefaultSocketTimeout());
        ...
        models = this.modelFactory.getModels("/asset/compressor-2015.tag-extensions.crank-frame-discharge-pressure", "Asset", headers);
        Assert.assertFalse((Boolean) ((Attribute) ((Asset) models.get(0)).getAttributes().get("alertStatus")).getValue().get(0));
    ...
    private RunAnalyticRequest getRunAnalyticRequestTestData()
    {
        ...
        Filter tsFieldFilter = getTimeseriesFieldFilter(assetUriName, assetUriValue,
     ...
     * @return -
     */
    private Filter getTimeseriesFieldFilter(String assetUriField, String assetUriValue,
